         ...
         <div class="documents-popup" style="opacity: 0;">
          <div class="doc-popup-header">
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <span class="hover">О компании</span>
              </div>
            </div>
          </div>
  ...
  if (document.cookie == false) {
    // условия зависимости контента от времени суток
     if (daytime >= 8 && daytime <= 17) { // day
      ...
      funcAnimation ( pathVidDay10, pathImgDay10, pathImgNight10, 1, 0, 0, 'block', 'none' ); 
      ...
      funcAnimation ( pathVidNight10, pathImgDay10, pathImgNight10, 0, 1, 0, 'none', 'block' );
...
$('#bgvid-link-day').click(function(){
  ...
  // вызываем функцию замены ссылок и анимации для дня
  funcAnimation ( pathVidDay10, pathImgDay10, pathImgNight10, 1, 0, 1000, 'block', 'none' );
...
$('#bgvid-link-night').click(function(){
  ...
  // вызываем функцию замены ссылок и анимации для дня
  funcAnimation ( pathVidNight10, pathImgDay10, pathImgNight10, 0, 1, 1000, 'none', 'block' );
