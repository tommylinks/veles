  ...
  if (document.cookie == false) {
    // условия зависимости контента от времени суток
     if (daytime >= 8 && daytime <= 17) { // day
      ...
      funcAnimation ( pathVidDay07, pathImgDay07, pathImgNight07, 1, 0, 0, 'block', 'none' ); 
      ...
      funcAnimation ( pathVidNight07, pathImgDay07, pathImgNight07, 0, 1, 0, 'none', 'block' );
...
$('#bgvid-link-day').click(function(){
  ...
  // вызываем функцию замены ссылок и анимации для дня
  funcAnimation ( pathVidDay07, pathImgDay07, pathImgNight07, 1, 0, 1000, 'block', 'none' );
...
$('#bgvid-link-night').click(function(){
  ...
  // вызываем функцию замены ссылок и анимации для дня
  funcAnimation ( pathVidNight07, pathImgDay07, pathImgNight07, 0, 1, 1000, 'none', 'block' );
