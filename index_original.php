...
<!--END preloader  -->
  ...
  <div class="navigation" style="position: absolute; left: 50%; top: 80%; margin-left: -50px; width: 100px; font-size: 40px; color: white;">
    <div class="prev snt-link" style="display: inline-block;"> < </div>
    <div class="start snt-link" style="display: inline-block;"> ^ </div>
    <div class="next snt-link" style="display: inline-block;"> > </div>
  </div>
