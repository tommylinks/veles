...
$manifest = "windowview.night.manifest";
...
<script>
  ...
  <div id = "pjax-global" style = "opacity: 0;">  
	...
	<img id="bgimg" class="img-bg bgimg-default" src="00.jpg" style = "" />
    <img id="bgimg-back" class="img-bg bgimg-default" src="00.jpg" style = "opacity: 1;" /> 
...
<!--  dermo START -->
 ...
 <!--  dermo END -->
  ...
  <div class="main-icon daynight secondary-p">
    <a href = '/omega/windowview/'><img id="" class="snt-link" src ="/omega/images/icons/day.png" style="position: absolute;" /></a>
  </div>
