          ...
          <div class="doc-popup-header">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <span class="bgvid-link-02 snt-link hover">События</span>
              </div>
            </div>
          </div>
  ...
  if (document.cookie == false) {
    // условия зависимости контента от времени суток
     if (daytime >= 8 && daytime <= 17) { // day
      ...
      funcAnimation ( pathVidDay11, pathImgDay11, pathImgNight11, 1, 0, 0, 'block', 'none' ); 
      ...
      funcAnimation ( pathVidNight11, pathImgDay11, pathImgNight11, 0, 1, 0, 'none', 'block' );
...
$('#bgvid-link-day').click(function(){
  ...
  // вызываем функцию замены ссылок и анимации для дня
  funcAnimation ( pathVidDay11, pathImgDay11, pathImgNight11, 1, 0, 1000, 'block', 'none' );
...
$('#bgvid-link-night').click(function(){
  ...
  // вызываем функцию замены ссылок и анимации для дня
  funcAnimation ( pathVidNight11, pathImgDay11, pathImgNight11, 0, 1, 1000, 'none', 'block' );
